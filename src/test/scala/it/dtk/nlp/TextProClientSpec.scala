...
object TextProClientSpec {
  ...
  val firstWordResult = Word("Ricercato", Some(1), Some(0), Some(9), Some("-"), Some("VSP"), Some("ricercare"), Some("ricercare+v+part+pass+m+nil+sing"), None, Some(Vector("O")), Some("B-VX"))
  ...
  val firstWordSummary = Word("L'", Some(1), Some(0), Some(2), Some("-"), Some("RS"), Some("det"), Some("det+art+_+sing"), None, Some(Vector("O")), Some("B-NP"))
...
Il latitante è stato arrestato e condotto in carcere."""
    ...
    val firstTextWord = Word("Era",Some(1),Some(0),Some(3),Some("-"),Some("VI"),Some("essere"),Some("essere+v+indic+imperf+nil+3+sing"),None,Some(Vector("O")),Some("B-VX"))

  val news = News(None, Option("http://www.baritoday.it/cronaca/"), Option("http://www.baritoday.it/cronaca/narcotrafficante-albanese-latitante-arrestato-a-cassano.html"),
